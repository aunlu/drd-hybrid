 ...
 * <em>not</em> throw {@link java.util.ConcurrentModificationException}.  However,
...
public class NonBlockingHashMapLong<TypeV> 
  ...
  // --- keySet --------------------------------------------------------------
  /** A class which implements the {@link java.util.Iterator} and {@link java.util.Enumeration}
  ...
  /** Returns a {@link java.util.Set} view of the keys contained in this map; with care
  ...
  /** Returns a {@link java.util.Set} view of the mappings contained in this map.  The
   *  set is backed by the map, so changes to the map are reflected in the
   *  set, and vice-versa.  The set supports element removal, which removes
